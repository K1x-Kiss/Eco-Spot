              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      _label("PRECIO"),
                      _input("price", "0.00", isNumber: true),
                    ],
                  ),
                ),
              ],
            ...
            Row(
              children: [
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [_label("CIUDAD"), _input("city", "Mendoza")],
                  ),
                ),
                SizedBox(width: 10),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [_label("PAÍS"), _input("country", "Argentina")],
                  ),
                ),
              ],
            ),
              ...
              children: [
                Expanded(
                  child: Column(
                    ...
                    children: [
                      _label("FECHA INICIO"),
                      _input("startingDate", "YYYY-MM-DD"),
                    ],
                  ),
                ),
                SizedBox(width: 10),
